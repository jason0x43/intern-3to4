...
declare module 'dojo/loader' {
	...
	namespace loader {
		...
		export interface IRequireMethods {
			toAbsMid(moduleId: string): string;
			toUrl(path: string): string;
		}
		export interface IRequire extends IRequireMethods {
			(
				config: IConfig,
				dependencies?: string[],
		...
		export interface IRootRequireMethods extends IRequireMethods {
		...
		export interface IRootRequire extends IRequire, IRootRequireMethods {}
		export interface IRequireCallback {
			(...modules: any[]): void;
		}
	}

	interface loader extends loader.IRootRequire {}
